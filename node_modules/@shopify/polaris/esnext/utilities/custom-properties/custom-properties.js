...
export const designLangaugeCustomProperties = [].concat(...Object.values(config).map((variant) => variant.map(({ name }) => toCssCustomPropertySyntax(name))), ...Object.keys(Tokens).map(toCssCustomPropertySyntax));
